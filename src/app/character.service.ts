...
export class CharacterService {
  ...
  getCharacter(id: string): Characters {
    const task = this.characters.filter(t => t.id === id)[0];
    const newCharacter= Object.assign({}, task);
    return newCharacter;
  }

  showCharacter( nombre: string){
    this.characters = this.characters.filter( c => c.id == nombre );
  }
